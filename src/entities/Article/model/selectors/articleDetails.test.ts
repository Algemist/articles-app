...
describe('articleDetails.test', () => {
    ...
    test('getArticleDetailsData test with empty value', () => {
        const state: DeepPartial<StateSchema> = {
            articleDetails: {},
        };
    ...
    test('getArticleDetailsIsLoading test with empty value', () => {
        const state: DeepPartial<StateSchema> = {
            articleDetails: {},
        };
    ...
    test('getArticleDetailsError test with empty value', () => {
        const state: DeepPartial<StateSchema> = {
            articleDetails: {},
        };
